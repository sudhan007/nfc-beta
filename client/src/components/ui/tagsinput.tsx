    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-lg bg-background overflow-hidden ",
            {
        ...
        >
          ...
          <Input
            ...
            className={cn(
              "outline-0 border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-gray-500 px-1",
